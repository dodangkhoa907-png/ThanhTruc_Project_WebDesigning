            ...
            <section class="story section" id="story">
                <div class="container">
                    ...
                    <div class="story-content reveal reveal-delay-2">
                        ...
                        <h2 class="section-title">Trái Cây Tươi Mới Mỗi Ngày</h2>
            ...
            <section class="values section" id="values">
                <div class="container">
                    ...
                    <div class="values-grid">
                        ...
                        <!-- Card 2: Giá Cả Sinh Viên -->
                        <div class="value-card reveal reveal-delay-2">
                            <div class="value-icon">💳</div>
                            <h3>Giá Cả Sinh Viên</h3>
                            <p>
                                Không lo về giá, phù hợp với túi tiền sinh viên.
                            </p>
                        </div>
                        ...
                        <form action="${pageContext.request.contextPath}/order" method="POST" id="orderForm" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="customerName" name="customerName"
                                    placeholder="Nguyễn Văn A" value="${prevName}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber"
                                    placeholder="0901234567" value="${prevPhone}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shippingAddress" name="shippingAddress"
                                    placeholder="123 Đường ABC, Quận XYZ, TP. HCM" value="${prevAddress}" required>
                            </div>
            ...
            <footer class="footer-nhiet-doi">
                ...
                <div class="footer-content">
                    ...
                    <div class="social-links">
                        <a href="https://www.facebook.com/share/1EMX9PdG2D/" target="_blank" class="social-btn"
                            aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/nhietdoixanh_05?igsh=dTR0dmgzcWg3aWV3" target="_blank"
                            class="social-btn" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                        <a href="https://tiktok.com/@nuocepnhietdoixanh_05" target="_blank" class="social-btn"
