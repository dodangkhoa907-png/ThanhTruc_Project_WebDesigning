    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
     ...
     ================================================================ -->
                        <section class="shop-hero">
                            <div class="shop-hero-banner"
                                style="background-image:url('${pageContext.request.contextPath}/images/category/Standee.png')"
                                aria-hidden="true"></div>
                            <div class="shop-hero-scrim" aria-hidden="true"></div>
                            <div class="container">
                                <div class="shop-hero-eyebrow">
                                    <i class="fa-solid fa-glass-water-droplet"></i> Nước ép &amp; sinh tố trái cây
                                    nguyên chất
                                </div>
     ...
     ================================================================ -->
                        <section class="shop-toolbar">
                            <div class="container">
                                <form id="shopFilterForm" method="GET"
                                    ...
                                    <div class="shop-sort">
                                        <select name="sort" id="shopSortSelect">
                                            <option value="moi-nhat" ${activeSort=='moi-nhat' ? 'selected' : '' }>Mới
                                                nhất</option>
                                            <option value="gia-tang" ${activeSort=='gia-tang' ? 'selected' : '' }>Giá
                                                thấp đến cao</option>
                                            <option value="gia-giam" ${activeSort=='gia-giam' ? 'selected' : '' }>Giá
                                                cao đến thấp</option>
                                            <option value="ten-az" ${activeSort=='ten-az' ? 'selected' : '' }>Tên A-Z
                                            </option>
                                        </select>
                                    </div>
                                </form>
                            ...
                            <div class="container">
                                <div class="shop-results-header">
                                    <span class="shop-results-count">
                                        ...
                                        <c:if test="${not empty keyword}"> cho "
                                            <c:out value="${keyword}" />"
                                        </c:if>
                                    </span>
                                </div>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${not empty p.imageUrl}">
                                                                <img src="${pageContext.request.contextPath}${p.imageUrl}"
                                                                    alt="${fn:escapeXml(p.name)}" loading="lazy">
                                                            </c:when>
                                                            <c:otherwise>
                                                    ...
                                                    <div class="shop-card-body">
                                                        ...
                                                        <div class="shop-card-footer">
                                                            <div class="shop-card-price">
                                                                <small>Từ</small>
                                                                <fmt:formatNumber value="${p.fromPrice}" type="number"
                                                                    groupingUsed="true" />đ
                                                            </div>
                                                            <c:choose>
