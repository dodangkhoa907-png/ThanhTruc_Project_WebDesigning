                                    ...
                                    <c:when test="${not empty cartItems}">
                                        ...
                                        <div class="cart-page-header">
                                            <div>
                                                ...
                                                <div class="cart-page-subtitle">${fn:length(cartItems)} sản phẩm trong
                                                    giỏ hàng</div>
                                            </div>
                                        ...
                                        <div class="cart-layout">
                                            ...
                                            <div>
                                                <div class="cart-select-all-bar">
                                                    ...
                                                    <span class="cart-select-all-count" id="selectAllCount">Đã chọn
                                                        0/${fn:length(cartItems)} sản phẩm</span>
                                                    <button type="button" class="cart-remove-selected-btn"
                                                        id="removeSelectedBtn" disabled>
                                                    ...
                                                    <c:forEach var="item" items="${cartItems}">
                                                        <div class="cart-item-card ${item.unavailable ? 'is-unavailable' : ''}"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                value="${item.cartItemId}" ${item.unavailable
                                                                ? 'disabled' : '' } aria-label="Chọn sản phẩm">
                                                            ...
                                                            <div class="cart-item-media">
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise><i
                                                                            class="fa-solid fa-leaf ph-icon"></i>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </div>
                                                            ...
                                                            <div class="cart-item-info">
                                                                ...
                                                                <div class="cart-item-meta">
                                                                    ...
                                                                    <span
                                                                        class="${not empty item.categoryName ? 'dot' : ''}">
                                                                        <c:out value="${item.sizeLabel}" />
                                                                    </span>
                                                                </div>
                                                                <div class="cart-item-unit-price">
                                                                    ${item.formattedUnitPrice}đ / sản phẩm</div>
                                                                <c:if test="${item.unavailable}">
                                                                    <span class="cart-item-unavailable-badge">Ngừng kinh
                                                                        doanh</span>
                                                                </c:if>
                                                            </div>
                                                            ...
                                                            <div class="cart-item-qty">
                                                                <div class="detail-qty-stepper">
                                                                    <button type="button" class="cart-qty-minus"
                                                                        aria-label="Giảm số lượng" ${item.unavailable
                                                                        ? 'disabled' : '' }>−</button>
                                                                    <input type="text" class="cart-qty-input"
                                                                        value="${item.quantity}" inputmode="numeric"
                                                                        aria-label="Số lượng" ${item.unavailable
                                                                        ? 'disabled' : '' }>
                                                                    <button type="button" class="cart-qty-plus"
                                                                        aria-label="Tăng số lượng" ${item.unavailable
                                                                        ? 'disabled' : '' }>+</button>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="cart-item-subtotal">
                                                                <span
                                                                    class="cart-item-subtotal-value">${item.formattedSubtotal}</span>đ
                                                            </div>
                                            ...
                                            <aside class="cart-summary">
                                                ...
                                                <button type="button" class="btn-shop btn-shop-primary" id="checkoutBtn"
                                                    disabled>
                                                ...
                                                <p class="cart-summary-note">
                                                    Giá cuối cùng và phí giao hàng sẽ được xác nhận lại ở bước thanh
                                                    toán.
                                                </p>
                                            </aside>
                                        </div>
